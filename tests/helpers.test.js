...
assert.equal(normalizeRoute("production", "Safety Officer"), "production");
...
assert.deepEqual(safetyRoutes, ["dashboard", "fleet", "production", "safety", "maintenance", "reports", "settings"]);
